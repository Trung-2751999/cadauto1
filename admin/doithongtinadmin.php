...
if(isset($_POST['change'])){
	$change_info=$change->changeinfo_admin($_POST);
...
<body>
	...
	<div class="left" style="float: left">			
				...
				<div class="menu">
					...
					<div class="doi-thong-tin-admin"style="background-color: #3C3434; color: #FF0606">ĐỔI THÔNG TIN ADMIN</div>
				</div>
	...
	<div class="right">
		<table class="add-thong-tin">
			<form method="post">
			<?php
				$show=$change->show_info_admin()->fetch_assoc();
			 ?>
			<tr>
				<td><label>TÊN ĐĂNG NHẬP:</label></td>
				<td><input type="text" name="user" value="<?php echo $show['admin_name'] ?>"></td>
			</tr>
			<tr>
				<td><label>TÊN ADMIN:</label></td>
				<td><input type="text" name="admin_name" value="<?php echo $show['name_admin'] ?>"></td>
			</tr>
			<tr>
				<td><label>MẬT KHẨU:</label></td>
				<td><input type="password" name="pass"value="<?php echo $show['admin_pass'] ?>"></td>
			</tr>
			<tr>
				<td><label>NHẬP LẠI MẬT KHẨU:</label></td>
				<td><input type="password" name="pass_2"value="<?php echo $show['admin_pass'] ?>"></td>
			</tr>
		</table>
		<center><input type="submit" name="change" value="UPDATE"></center>
		</form>
	</div>
</body>
